...
/**
 *  display a toast for an error message  (must be inside .toast-container)
 * @param  $string string
 *
 **/
    ...
    echo '<div class="toast align-items-center text-light bg-danger border-0 w-auto" data-bs-animation="true" data-bs-autohide="true" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="d-flex">
                    <div class="toast-body d-flex justify-content-center align-items-center" >
                        ...
                        <svg class="bi  me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                        ' . $string . '
                    </div>
...
/**
 *  display a toast for a warning message (must be inside .toast-container)
 * @param $string string
 * @return  void
 **/
...
/**
 *  display a toast for a success message (must be inside .toast-container)
 * @param $string string
 * @return  void
 **/
...
function msg_alert_error(string $string): void
{
    if (empty($string)) return;
...
function msg_alert_warning(string $string): void
{
    if (empty($string)) return;
    echo '<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                        <symbol id="exclamation-triangle-fill" fill="currentColor" viewBox="0 0 16 16">
